...
# Install APOC plugin for Neo4j (official release asset: apoc-5.18.0-core.jar)
ARG APOC_VERSION=5.18.0
COPY neo4j_plugins/apoc-${APOC_VERSION}-core.jar /var/lib/neo4j/plugins/
RUN ln -sf /var/lib/neo4j/plugins/apoc-${APOC_VERSION}-core.jar /var/lib/neo4j/plugins/apoc.jar
